...
# Load APEATO results
with open("/home/kiyotoka/Desktop/os/YAFS/apeato_simulation_results.json") as f:
    data = json.load(f)
...
df = pd.DataFrame({
    ...
    "Energy":  [31.83, 5.42, 3.45, apeato_energy],
    "Latency": [3.18, 3.18, 1.82, apeato_latency],
    "DeadlineSuccess": [0.70, 0.60, 0.85, apeato_deadline]
})
